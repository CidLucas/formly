...
export default function Auth() {
  ...
  // TODO(Supabase): quando o Supabase Auth estiver configurado, plugar aqui o
  ...
  return (
    ...
    >
      <div className="auth">
        ...
        <div className="title">Só mais uma coisa</div>

        <div className="subtitle">Crie uma conta rapidinho para salvar seu questionário.</div>

        <button type="button" className="btn-google" onClick={() => void devLogin()} disabled={busy}>
